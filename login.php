<?php
session_start();
include 'koneksi.php'; // Tambahkan ini
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($username == 'Hazzel' && $password == '2409106096') {
...
mysqli_close($koneksi); // Tambahkan ini
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
    <header>
        <h1 style="margin: 0;">Data Manajemen Mahasiswa Unmul</h1>
    </header>
